...
def load_nifty200(spreadsheet):
    ...
    for row in values[1:]:
        ...
        # ONLY NSE Code is retained.
        # Turnover Rank / Turnover / Volume
...
def analyze_stock(symbol):
    ...
    # Volume comes from Yahoo Finance,
    # NOT from NIFTY200 sheet.
    ...
    # Volume filter
    #
    # This uses Yahoo Finance volume.
    # It does NOT use NIFTY200 Volume.
    # --------------------------------------------------------
...
def main():
    ...
    print(
        f"Total NIFTY200 stocks: "
        f"{total}"
    )

    print(
        f"Valid divergence signals: "
        f"{len(results)}"
    )
